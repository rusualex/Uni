...
#line 137 "grammar.tab.c" /* yacc.c:339  */
...
#line 213 "grammar.tab.c" /* yacc.c:355  */
};
...
{
       0,   124,   124,   144,   150,   157,   163,   167,   173,   178,
     183,   189,   205,   213,   222,   226,   241,   249,   258,   261,
     266,   273,   282,   299,   306,   314,   321,   335,   350,   355,
     361,   367
};
#endif
...
#line 125 "grammar.y" /* yacc.c:1646  */
    {
                ...
                strcat(ids,vars);
                sprintf(temp,"assume cs:code,ds:data\ndata segment\n%s\ndata ends\ncode segment\nstart:\nmov ax,data\nmov ds,ax\n%s\nmov ah,4ch\nint 21h\n%s\ncode ends\nend start\n",ids,(yyvsp[-4].attributes).code,display_function);
...
#line 151 "grammar.y" /* yacc.c:1646  */
    {
                char temp[10000];
                sprintf(temp,"%s\n%s\n",(yyvsp[-1].attributes).code,(yyvsp[0].attributes).code);
                (yyval.attributes).code=strdup(temp);
                (yyval.attributes).varn="";
            }
...
#line 158 "grammar.y" /* yacc.c:1646  */
    {
                (yyval.attributes).code=strdup((yyvsp[0].attributes).code);
                (yyval.attributes).varn="";
            }
...
#line 190 "grammar.y" /* yacc.c:1646  */
    {
                char temp[5000];
                if(strcmp((yyvsp[0].exprAttr).op,"-")==0)
                {
                    (yyval.attributes).varn = (yyvsp[-1].attributes).varn;
                    sprintf(temp,"%s\n",(yyvsp[-1].attributes).code);
                    //sprintf(temp,"%s\n%s\nmov ax,%s\nmov %s,ax\n",$1.code,$2.code,$1.varn,$$.varn);
                }
                else
                {
                    (yyval.attributes).varn = NewTempName();
                    sprintf(temp,"%s\n%s\nmov ax,%s\nmov bx,%s\n%s ax,bx\nmov %s,ax",(yyvsp[-1].attributes).code,(yyvsp[0].exprAttr).code,(yyvsp[-1].attributes).varn,(yyvsp[0].exprAttr).varn,(yyvsp[0].exprAttr).op,(yyval.attributes).varn);
                }
                (yyval.attributes).code=strdup(temp);
            }
...
#line 206 "grammar.y" /* yacc.c:1646  */
    {
                ...
                char temp[5000];
                sprintf(temp,"%s\nmov ax,%s\nmov %s,ax\n",(yyvsp[0].attributes).code,(yyvsp[0].attributes).varn,(yyval.exprAttr).varn);
...
#line 227 "grammar.y" /* yacc.c:1646  */
    {
                ...
                {
                    (yyval.attributes).varn=NewTempName();
                    sprintf(temp,"%s\n%s\nmov ax,%s\nmov bx,%s\n%s bx\nmov %s,ax\n",(yyvsp[-1].attributes).code,(yyvsp[0].exprAttr).code,(yyvsp[-1].attributes).varn,(yyvsp[0].exprAttr).varn,(yyvsp[0].exprAttr).op,(yyval.attributes).varn);
                }
                (yyval.attributes).code=strdup(temp);
            }
...
#line 262 "grammar.y" /* yacc.c:1646  */
    {
                (yyval.attributes).varn = strdup((yyvsp[0].attributes).varn);
                (yyval.attributes).code="";
            }
...
#line 274 "grammar.y" /* yacc.c:1646  */
    {
                char temp[1000];
                (yyval.attributes).varn=NewTempName();
                sprintf(temp,"%s\nmov ax,%s\nmov %s,ax",(yyvsp[-1].attributes).code,(yyvsp[-1].attributes).varn,(yyval.attributes).varn);
                (yyval.attributes).code=strdup(temp);
...
#line 283 "grammar.y" /* yacc.c:1646  */
    {
            ...
            */
                ...
                sprintf(temp,"%s%s\n%s\n%s:\n",(yyvsp[-4].attributes).code,lbl,(yyvsp[-1].attributes).code,lbl);
                (yyval.attributes).code=strdup(temp);
        }
...
#line 300 "grammar.y" /* yacc.c:1646  */
    {
            char temp[500];
            sprintf(temp,"%s\nmov ax,%s\nmov %s,ax\n",(yyvsp[-1].attributes).code,(yyvsp[-1].attributes).varn,(yyvsp[-3].attributes).varn);
            (yyval.attributes).code=strdup(temp);
        }
...
#line 307 "grammar.y" /* yacc.c:1646  */
    {
            (yyval.attributes).varn="";
            char temp[100];
            sprintf(temp,"mov ax,%s\ncall disp",(yyvsp[-1].attributes).varn);
            (yyval.attributes).code=strdup(temp);
        }
...
#line 336 "grammar.y" /* yacc.c:1646  */
    {
            ...
            */
            char* temp =malloc(1000*sizeof(char)); 
            sprintf(temp,"%s\n%s\nmov ax,%s\nmov bx,%s\ncmp ax,bx\n%s ",(yyvsp[-2].attributes).code,(yyvsp[0].attributes).code,(yyvsp[-2].attributes).varn,(yyvsp[0].attributes).varn,(yyvsp[-1].attributes).code);
            (yyval.attributes).code=strdup(temp);
            free(temp);
            (yyval.attributes).varn="";
        }
...
#line 372 "grammar.y" /* yacc.c:1906  */
